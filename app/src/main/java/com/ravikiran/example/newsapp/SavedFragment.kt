...
import com.ravikiran.example.newsapp.databinding.FragmentSavedBinding
...
class SavedFragment : Fragment() {
    ...
    // data binding for saved fragment recyclerview data
    private lateinit var viewBinding: FragmentSavedBinding

    // intilize adapter for recyclerview
    @Inject
